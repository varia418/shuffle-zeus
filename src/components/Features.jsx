...
function Features() {
	return (
		<section className="container mx-auto py-20 px-24 flex flex-wrap">
			<div className="flex lg:w-1/3 pb-20 gap-4">
				...
				<div className="pr-20">
					...
					<p className="text-gray-500">
						...
						them with previous projects. More interesting writings
						for your customers.
					</p>
				</div>
			</div>
			<div className="flex lg:w-1/3 pb-20 gap-4">
				<div>
					<span className="block bg-blue-400 rounded-full w-10 h-10 flex items-center justify-center">
						<svg
							width="20"
							height="20"
							viewBox="0 0 20 20"
			...
			<div className="flex lg:w-1/3 pb-20 gap-4">
				<div>
					<span className="block bg-red-500 rounded-full w-10 h-10 flex items-center justify-center">
						<svg
							width="18"
							height="20"
							viewBox="0 0 18 20"
			...
			<div className="flex lg:w-1/3 pb-20 gap-4">
				<div>
					<span className="block bg-orange-600 rounded-full w-10 h-10 flex items-center justify-center">
						<svg
							width="22"
							height="20"
							viewBox="0 0 22 20"
			...
			<div className="flex lg:w-1/3 pb-20 gap-4">
				<div>
					<span className="block bg-yellow-400 rounded-full w-10 h-10 flex items-center justify-center">
						<svg
							width="24"
							height="20"
							viewBox="0 0 24 20"
			...
			<div className="flex lg:w-1/3 pb-20 gap-4">
				<div>
					<span className="block bg-gray-900 rounded-full w-10 h-10 flex items-center justify-center">
						<svg
							width="22"
							height="18"
							viewBox="0 0 22 18"
